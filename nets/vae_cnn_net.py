...
class VAEC(pl.LightningModule):
    def __init__(self,
                 ...
                 loss_type : str = 'mse',
                 n_samples : int = 1,
                 outname : str = './VAEC_untitled/LITcollVAE_'):
        super().__init__()
        assert len(l) >= 3
        assert len(lw) == 3
        ...
        print("[Initializing VAEC Module]")
    ...
    def on_train_start(self):
        print("\n\n==================================")
        print("Starting training VAEC module")
        print("==================================")
    ...
    def plot_training(self, ax):
        ax[0].set_title("VAEC Network Loss minimization")
        ax[0].set_yscale("log")
        ax[0].plot(
    ...
    def plot_latent(self, fig, ax, latent_mu, latent_sd, train_y, i, j):
        ax.set_title("VAEC Latent-space-"+str(i))
