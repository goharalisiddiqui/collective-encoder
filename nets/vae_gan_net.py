...
class VAEGAN(pl.LightningModule):
    def __init__(self,
        ...
        self.step_gan_loss_list = []
        self.train_gan_loss_list = []
    ...
    def on_train_epoch_end(self):
        ...
        self.train_gan_loss_list.append(list_mean(self.step_gan_loss_list))
    ...
    def get_gan_loss(self):
        if len(self.train_gan_loss_list) > 0:
            return self.train_gan_loss_list[-1]
        else:
            return 0.0
    ...
    def plot_all(self, data_x, data_y):
        ...
        fig, axes = plt.subplots(1, 4, squeeze=True,figsize=(6 * 3, 6))
    ...
    def plot_training(self, ax):
        ...
        ax[3].set_title("GAN Loss minimization")
        ax[3].set_yscale("log")
        ax[3].plot(
            np.asarray(self.train_gan_loss_list),
            ".-",
            c="tab:orange",
        )
        ax[3].set_xlabel("Epoch")
        ax[3].set_ylabel("GAN loss")
