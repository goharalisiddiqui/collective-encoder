...
def get_dataset_cls_dl(dataset_type: str, dataset_args, datareader) \
    ...
    if dataset_type in ['DEFAULT', 'POSITIONS']:
        from collective_encoder.datasets.positions import PositionsDataset as dataset_class
        dl_cls = DataLoader
        ...
        from collective_encoder.datasets.soap_ps import SoapPowerSpectrumDataset as dataset_class
        dataset_args = soap_modifications(dataset_args, datareader)
        dl_cls = DataLoader
    else:
